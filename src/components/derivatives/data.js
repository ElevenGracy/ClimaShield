export const AccordionData=[
    {
        que:"1. What is a weather derivative contract?",
    ...
    {
        que:"5. How are CDD calculated?",
        ans:"CDD (Cooling Degree Day) : " + "Subtract 65 from the average of a day's high and low temperatures. For example, if the day's average temperature is 75° F, its CDD is 10. If that day's average is below 65, the result is set to zero. Meanwhile, if every day in a 30-day month had an average temperature of 75° F, the month's CDD value would be 300 (10 x 30)."
    },
    {
        que:"6. What is the strike value?",
